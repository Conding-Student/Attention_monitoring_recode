					...
					<div className="w-full max-w-[760px] rounded-[24px] border border-white/80 bg-white/85 px-5 py-6 shadow-[0_24px_70px_rgba(15,23,42,0.12)] backdrop-blur-2xl transition-colors sm:px-8 sm:py-7 dark:border-slate-700/70 dark:bg-slate-900/80 dark:shadow-[0_24px_70px_rgba(0,0,0,0.4)]">
						...
						>
							...
							<div>
								...
								<div className="flex min-h-[78px] flex-col gap-3 rounded-xl border border-gray-200 bg-gray-50/90 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-5 dark:border-slate-700 dark:bg-slate-950/55">
									...
									<button
										...
										className="inline-flex h-10 shrink-0 items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-4 text-xs font-semibold text-[#07594b] shadow-sm transition-all hover:border-[#07594b]/30 hover:bg-emerald-50 active:scale-[0.98] sm:text-sm dark:border-slate-700 dark:bg-slate-900 dark:text-emerald-400 dark:hover:border-emerald-500/40 dark:hover:bg-emerald-950/50"
									>
										{copiedField === "code" ? (
											<Check size={16} />
										) : (
							...
							<div>
								...
								<div className="flex h-12 items-center overflow-hidden rounded-xl border border-gray-200 bg-white/90 transition-all hover:border-gray-300 focus-within:border-[#07594b] focus-within:ring-4 focus-within:ring-emerald-100/70 dark:border-slate-700 dark:bg-slate-950/60 dark:hover:border-slate-600 dark:focus-within:border-emerald-500 dark:focus-within:ring-emerald-950">
							...
							<button
								type="submit"
								className="group flex h-13 w-full items-center justify-center gap-2.5 rounded-xl bg-[#07594b] px-6 text-sm font-bold text-white shadow-lg shadow-emerald-950/10 transition-all hover:-translate-y-0.5 hover:bg-[#064c40] hover:shadow-xl hover:shadow-emerald-950/20 active:translate-y-0 active:scale-[0.99] dark:bg-emerald-600 dark:hover:bg-emerald-500"
							>
								Start Meeting
