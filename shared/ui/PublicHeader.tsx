...
export default function PublicHeader() {
	...
	return (
        <>
            <header className="fixed inset-x-0 top-0 z-50 transform-gpu border-b border-gray-100 bg-white shadow-sm transition-colors duration-300 dark:border-slate-800 dark:bg-slate-950">                <div className="mx-auto flex h-[72px] max-w-[1440px] items-center justify-between gap-2 px-4 sm:px-8 lg:px-14">
